package hei.school.gestion.handler;

import static hei.school.gestion.concurrency.ThreadRenamer.renameWorkerThread;
...
import hei.school.gestion.PojaApplication;
import hei.school.gestion.PojaGenerated;
import hei.school.gestion.endpoint.EndpointConf;
import hei.school.gestion.endpoint.event.EventConf;
import hei.school.gestion.endpoint.event.consumer.EventConsumer;
import hei.school.gestion.endpoint.event.consumer.model.ConsumableEvent;
import hei.school.gestion.endpoint.event.consumer.model.ConsumableEventTyper;
