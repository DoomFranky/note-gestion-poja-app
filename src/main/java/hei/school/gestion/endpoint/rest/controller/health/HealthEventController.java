package hei.school.gestion.endpoint.rest.controller.health;

import static hei.school.gestion.endpoint.rest.controller.health.PingController.KO;
import static hei.school.gestion.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import hei.school.gestion.PojaGenerated;
import hei.school.gestion.endpoint.event.EventProducer;
import hei.school.gestion.endpoint.event.model.DurablyFallibleUuidCreated1;
import hei.school.gestion.endpoint.event.model.UuidCreated;
import hei.school.gestion.repository.DummyUuidRepository;
import hei.school.gestion.repository.model.DummyUuid;
