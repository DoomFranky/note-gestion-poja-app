package hei.school.gestion.endpoint.event.model;

import static hei.school.gestion.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.school.gestion.PojaGenerated;
import hei.school.gestion.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "hei.school.gestion.event1";
  }
}
