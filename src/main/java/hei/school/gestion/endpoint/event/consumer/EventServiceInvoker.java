package hei.school.gestion.endpoint.event.consumer;

import hei.school.gestion.PojaGenerated;
import hei.school.gestion.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.school.gestion.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.school.gestion.service.event."
